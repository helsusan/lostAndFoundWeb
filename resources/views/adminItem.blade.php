                    ...
                    <tr class="border-b h-[170px]">
                        ...
                        <div class="flex flex-col items-center gap-2"></div>
                            ...
                            <form action="{{ route('admin.deleteItem', $item->id) }}" method="POST" class="w-full">
                                @csrf
                                @method('DELETE')
                                <button type="button" class="buttondelete flex items-center justify-start bg-red-600 hover:bg-red-700 text-white px-4 py-2 rounded-lg w-full font-bold">
