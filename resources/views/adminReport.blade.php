        ...
        <table class="min-w-full table-auto border-collapse">
            <thead>
                <tr class="bg-[#133E87] text-left text-white"> 
                    <th class="w-1/12 py-4 px-6 border-b text-sm font-bold uppercase text-center">ID</th>
                    ...
                    <th class="w-1/12 py-4 px-6 border-b text-sm font-bold uppercase text-center">Verified</th>
            ...
            <tbody>
                @if($reports->isEmpty())
                    <tr>
                        <td colspan="11" class="py-4 px-6 text-center text-white font-medium">
                    ...
                    <tr class="@if($loop->even) bg-[#133E87] @else bg-[#a9c6ff] @endif">
                        ...
                        <td class="py-4 px-6 border-b">
                            ...
                            @else
                                ...
                                class="bg-green-500 text-white px-4 py-2 rounded hover:bg-green-600 font-bold">
                                    Detail
                                </a>
                            @endif
                        </td>
                        ...
                        <td class="py-4 px-6 border-b text-center flex flex-col space-y-2">
                            ...
                            <a href="{{ route('admin.editReport', $report->id) }}" class="flex items-center justify-start bg-[#f3cf56] text-white px-4 py-2 rounded hover:bg-[#e6be40] w-full font-bold">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
