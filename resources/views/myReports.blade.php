...
<div class="text-right my-5 mr-20">
    <a href="{{ route('myreport.createReport') }}" class="bg-green-600 hover:bg-green-700 text-white font-medium rounded-lg text-sm px-5 py-2.5 focus:ring-4 focus:outline-none focus:ring-green-300 inline-flex items-center justify-center">
        ...
        <table id="Table" class="min-w-full table-auto border-collapse rounded-lg">
            ...
            <tbody>
                ...
                <tr class="">
                    ...
                    <td class="py-4 px-6 border-b font-medium text-left">{{ $report->location->name ?? 'N/A' }} - {{ $report->location->building ?? 'N/A' }}</td>
                    ...
                    <td class="py-4 px-6 border-b text-center">
                        <div class="flex flex-col items-center gap-2">
                            ...
                            <form id="findform" action="{{ route('myreport.foundReport', $report->id)}}" method="POST">
                                @csrf
                                @method('PUT')
                                <button data-id="{{$report->id }}" type="submit" id="findbutton" class="flex items-center justify-start bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700 min-w-[120px] font-bold">
                                <svg xmlns="http://www.w3.org/2000/svg" style="margin-right:8px;" height="14" width="14" viewBox="0 0 512 512">
